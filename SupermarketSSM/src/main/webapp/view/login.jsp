	    ...
	    <div class="rg_layout">
	        <div class="rg_center" >
                ...
                <form method="post" class="layui-form">
                    <table>
                    	<tr>
                           	<p class="title_header">海豚超市前台收银系统</p>
                        </tr>
                        <tr>
                            <td class="td_left"><label for="username">用户名</label></td>
                            <td class="td_right"><input autocomplete="off" type="text" name="salesPersonId" id="username" placeholder="请输入用户名" value="${fname}"></td>
                        </tr>
                        <tr>
                            <td class="td_left"><label for="password">密码</label></td>
                            <td class="td_right"><input type="password" name="loginPwd" id="password" placeholder="请输入密码" value="${fpassword}"></td>
                        </tr>
                        <tr>
                        	<td class="td_left"></td>
		...
		layui.use(['layer', 'form'], function(){
			  ...
			  form.on('submit(demo1)', function(data){
			  	...
			  	if (username==undefined||username=="") {
					...
					$.post("${ctx}/receptionLogin/login",data.field,function(data){
						if(data==1){
							layer.msg('没有此用户', {icon: 5,anim: 6});
						}else if(data==2){
							layer.msg('密码错误', {icon: 5,anim: 6});
						}else if(data==3){
							window.location.href="${ctx}/view/frontDesk/main.jsp";
						}
